...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 15 nov. 2022 à 12:19
...
INSERT INTO `document` (`id`, `titre`, `image`, `commandeEnCours`, `idCategorie`) VALUES
...
--
-- Structure de la table `doc_est_decrit_par`
--

CREATE TABLE `doc_est_decrit_par` (
  `idDoc` varchar(10) NOT NULL,
  `idDesc` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `doc_est_decrit_par`
--

INSERT INTO `doc_est_decrit_par` (`idDoc`, `idDesc`) VALUES
('00005', '10004'),
('00005', '10006');
...
INSERT INTO `revue` (`id`, `titre`, `empruntable`, `periodicite`, `delai_miseadispo`, `dateFinAbonnement`, `idDesc`, `idCategorie`) VALUES
('10001', 'Arts Magazine', 'O', 'MS', 52, '2022-03-31', '00002', '00001'),
('10002', 'Alternatives Economiques', 'O', 'HB', 52, '2022-04-30', '00001', '00001'),
('10003', 'Challenges', 'O', 'HB', 26, '2022-02-28', '00001', '00001'),
('10004', 'Rock and Folk', 'O', 'MS', 52, '2022-10-31', '00002', '00001'),
('10005', 'Les Echos', 'N', 'QT', 5, '2022-12-31', '00001', '00001'),
('10006', 'L\'Equipe', '0', 'QT', 5, '2022-01-31', '00003', '00001'),
('10007', 'Telerama', '1', 'HB', 26, '2022-01-31', '00002', '00001'),
('10008', 'L\'Obs', '1', 'HB', 26, '2022-01-31', '00004', '00001'),
('10009', 'Le Monde', '0', 'QT', 5, '2022-01-31', '00003', '00001'),
('10010', 'L\'Equipe Magazine', '1', 'HB', 12, '2022-01-31', '00003', '00001'),
('10011', 'Geo', '1', 'MS', 52, '2022-01-31', '00002', '00001');
...
--
-- Index pour la table `doc_est_decrit_par`
--
ALTER TABLE `doc_est_decrit_par`
  ADD PRIMARY KEY (`idDoc`,`idDesc`),
  ADD KEY `idDesc` (`idDesc`);
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`idDoc`) REFERENCES `document` (`id`);

--
-- Contraintes pour la table `document`
--
ALTER TABLE `document`
  ADD CONSTRAINT `document_ibfk_1` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`id`);

--
-- Contraintes pour la table `doc_est_decrit_par`
--
ALTER TABLE `doc_est_decrit_par`
  ADD CONSTRAINT `doc_est_decrit_par_ibfk_1` FOREIGN KEY (`idDoc`) REFERENCES `document` (`id`),
  ADD CONSTRAINT `doc_est_decrit_par_ibfk_2` FOREIGN KEY (`idDesc`) REFERENCES `descripteur` (`id`);

--
-- Contraintes pour la table `dvd`
--
ALTER TABLE `dvd`
  ADD CONSTRAINT `dvd_ibfk_1` FOREIGN KEY (`id`) REFERENCES `document` (`id`);

--
-- Contraintes pour la table `exemplaire`
--
ALTER TABLE `exemplaire`
  ADD CONSTRAINT `exemplaire_ibfk_1` FOREIGN KEY (`idDoc`) REFERENCES `document` (`id`),
...
--
ALTER TABLE `livre`
  ADD CONSTRAINT `livre_ibfk_1` FOREIGN KEY (`id`) REFERENCES `document` (`id`);
...
--
ALTER TABLE `revue`
  ADD CONSTRAINT `revue_ibfk_1` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`id`),
  ADD CONSTRAINT `revue_ibfk_2` FOREIGN KEY (`idDesc`) REFERENCES `descripteur` (`id`);
COMMIT;
